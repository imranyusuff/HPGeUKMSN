...
G4VPhysicalVolume *HPGeUKMSNDetectorConstruction::DefineVolumes()
{
  ...
  G4Box *worldS = new G4Box("world", 10.*m, 20.*m, 10.*m);
  ...
  G4Tubs *baseshieldS = new G4Tubs("baseShield", 63.1*mm, 244.5*mm, 51.2*mm, 0.*deg, 360.*deg);
  ...
  G4ThreeVector baseshield3V = G4ThreeVector(0, 51.2*mm, 0);
  ...
  G4Tubs *bodyshieldS = new G4Tubs("bodyShield", 142.1*mm, 244.5*mm, 204.3*mm, 0.*deg, 360.*deg);
  ...
  G4ThreeVector bodyshield3V = G4ThreeVector(0, 306.7*mm, 0);
  ...
  G4Tubs *doorshieldS = new G4Tubs("doorShield", 0, 244.5*mm, 51.2*mm, 0.*deg, 360.*deg);
  ...
  G4ThreeVector doorshield3V = G4ThreeVector(0, 562.2*mm, 0);
  ...
  G4Tubs *detS = new G4Tubs("detector", 0, 35*mm, 103.7*mm, 0.*deg, 360.*deg);
  ...
  G4ThreeVector det3V = G4ThreeVector(0, 103.7*mm, 0);
  ...
  G4ThreeVector src3V = G4ThreeVector(0, (103.7*2 + 20.)*mm, 0);
